...
describe("herokuapp", () => {
    ...
    context("javascript alerts", () => {
        it("Handle javascript alert", () => {
            ...
            */
            ...
            cy.get('ul button').contains("Click for JS Alert")
            .click().then(()=>{
                cy.wait(100)
        ...
        it("Confirm Javascript alert", () =>{
            ...
            cy.get('ul  button').contains("Click for JS Confirm")
            .click()
        ...
        it("Javascript text box", () => {
            ...
            cy.get('ul  button').contains("Click for JS Prompt")
            .click()
    ...
    // Check if can use cypress-file-upload plugin
